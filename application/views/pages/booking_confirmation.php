...
<script>
const helcim = new HelcimJS({
    apiToken: '<?= $this->config->item('helcim')['api_key'] ?>',
    accountId: '<?= $this->config->item('helcim')['account_id'] ?>',
    test: <?= $this->config->item('helcim')['test_mode'] ? 'true' : 'false' ?>
});
</script>
