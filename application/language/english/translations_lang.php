...
$lang['cancel'] = 'Cancel';
$lang['appointment_registered'] = 'Your Appointment Has Been Set!';
...
$lang['appointment_details_was_sent_to_you'] = 'You Will Receive an Email and Text Notification With Your Appointment Details';
...
$lang['end'] = 'End';
$lang['name'] = 'Name';
$lang['appointment_link_title'] = 'Reschedule';
...
$lang['about_app'] = 'About Infogito Sync';
...
$lang['about_app_info'] = 'Infogito Sync is a highly customizable web application that allows your customers to book appointments with you via the web. Moreover, it provides the ability to sync your data with Google Calendar, so you can use them with other services.';
$lang['current_version'] = 'Current Version';
$lang['support'] = 'Support';
$lang['about_app_support'] = 'If you encounter any problems when using Infogito Sync you can search the official Google Group for answers. You might also need to create a new issue on the Google Code page in order to help the development progress.';
...
$lang['about_app_license'] = 'Infogito Sync is licensed under the GPLv3 license. By using the code of Infogito Sync in any way you are agreeing to the terms described in the following url:';
...
$lang['backend_section'] = 'Infogito Sync';
$lang['you_need_to_login'] = 'Login to access your calendar and bookings settings';
...
$lang['ea_update_success'] = 'Infogito Sync has been successfully updated.';
...
$lang['api_token_hint'] = 'Set a secret token in order to enable the token based authentication of the Infogito Sync API.';
...
$lang['api'] = 'API';
$lang['api_info'] = 'API enable you to interact with all the Infogito Sync data via the HTTP protocol and the available API endpoints and create your own integrations.';
...
$lang['ldap'] = 'LDAP';
$lang['ldap_info'] = 'This integration enables you to connect to an existing LDAP server and automatically import users into Infogito Sync and let them SSO with their directory password (username must match).';
$lang['host'] = 'Host';
$lang['port'] = 'Port';
